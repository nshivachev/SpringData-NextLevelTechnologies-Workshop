...
public enum Constants {
    ...
    public static final Path PROJECTS_IMPORT_XML = Path.of("NextLevelTechnologies", "src", "main", "resources", "files", "xmls", "projects.xml");
    public static final Path EMPLOYEES_IMPORT_XML = Path.of("NextLevelTechnologies", "src", "main", "resources", "files", "xmls", "employees.xml");
